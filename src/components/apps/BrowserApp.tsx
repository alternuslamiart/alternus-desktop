  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="flex items-center gap-4 px-4 py-2 flex-shrink-0" style={{ borderBottom: `1px solid ${c.border}`, minHeight: 40 }}>
        ...
        <div className="flex-1 flex items-center gap-4 px-4 py-2 rounded-lg" style={{ background: c.cardAlt, border: `1px solid ${c.border}` }}>
          {isLoading ? (
      ...
      <div className="flex items-center gap-2 px-4 py-2 flex-shrink-0" style={{ borderBottom: `1px solid ${c.border}` }}>
        {bookmarks.map((b, i) => (
          <button key={i} onClick={() => navigate(b.url)} className="px-3 py-1 rounded-md text-[11px] font-medium transition-colors"
